...
>
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="{{route('dashboard.transaction.transactions.index')}}" aria-expanded="false">
                                <span>
                                    <i class="ti ti-book"></i>
                                </span>
                                <span class="hide-menu">Pemesanan Obat</span>
                            </a>
                        </li>
                        <!-- ============================= -->
                        <!-- Apps -->
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="{{route('dashboard.drug.drugs.index')}}" aria-expanded="false">
                                <span>
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="{{route('dashboard.distributor.distributors.index')}}" aria-expanded="false">
                                <span>
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="{{route('dashboard.detailtransaction.detailtransactions.index')}}" aria-expanded="false">
                                <span>
                                    <i class="ti ti-history"></i>
                                </span>
                                <span class="hide-menu">Riwayat Pemesanan Obat</span>
                            </a>
                        </li>
                    </ul>
                </nav>
